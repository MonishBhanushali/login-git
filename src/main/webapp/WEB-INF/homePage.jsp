...
<head>
  ...
  <title>Jasper Products HomePage</title>
  ...
  <style>
    ...
    .intro {
      ...
      width: 100%;
      height: 520px;
      background: linear-gradient(to bottom, rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.5) 100%), url("https://springbootimages.s3.amazonaws.com/img1.png");
...
<body>
  ...
  <main>
    <div class="intro">
      <h1>A Jasper Products</h1>
      <p>Welcome to jasper products website.</p>
    ...
    <div class="about-me">
      ...
      <img src="D:\springboot_Microservices\login\src\main\resources\static\images\img1" alt="me">
    </div>
  </main>
  <footer class="footer">
